...
async function main() {
  ...
  console.log(`   Oracle: ${addresses.PriceOracleWrapper}`);
  ...
  console.log(`   Model: ${addresses.InterestRateModel}`);
  ...
  console.log(`   Pool: ${addresses.LendingPool}`);
